...
6. **[認証方式]** として **[oAuth2]** を選択し、 **[サインイン]** を選択します。 
...
GitHub テンプレート アプリをインストールできました。 これは、GitHub ワークスペースも作成されたことを意味します。 ワークスペースでは、レポートとダッシュボードを変更して、それを組織内の同僚に "*アプリ*" として配布することができます。 

1. ナビ ペインで、ワークスペース名の横にある矢印を選択します。 ワークスペースにダッシュボードとレポートが含まれていることがわかります。
...
3. 新しい GitHub ワークスペースのすべてのコンテンツを表示するには、ナビゲーション ペインで、 **[ワークスペース]**  >  **[GitHub]** の順に選択します。
 
   ![ナビゲーション ペインの GitHub ワークスペース](media/service-connect-to-github/power-bi-github-left-nav.png)
