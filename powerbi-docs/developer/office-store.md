...
Power BI ビジュアルを作成した後、それを AppSource に発行することで、他のユーザーがそれを探して使用できるようにすることができます。 Power BI ビジュアルの作成の詳細については、[Power BI ビジュアルの開発](visuals/custom-visual-develop-tutorial.md)に関する記事を参照してください。
