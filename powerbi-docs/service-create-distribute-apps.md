...
5. **[アクセス許可]** で、アプリへのアクセス許可を持っているユーザーと、そのアクセス許可で実行できる操作を決定します。 
    ...
    - アプリ ユーザーに対して、アプリの基になっているデータセットに、ビルド アクセス許可を使用して接続を許可できます。 これらのデータセットは、データセットの検索で表示できます。
    - アプリ ユーザーに対して、このアプリのレポートをマイ ワークスペースにコピーすることを許可できます。 
...
## <a name="allowing-users-to-connect-to-the-apps-underlying-datasets"></a>ユーザーにアプリの基になっているデータセットへの接続を許可する
アプリの基になっているデータセットに対して、すべてのユーザーに接続を許可するオプションをオンにすると、アプリのユーザーは基になっているデータセットのビルド アクセス許可を得ることになります。 これにより、ユーザーは Power BI Desktop でこれらのデータセットを検索し、サービスがデータ エクスペリエンスを取得し、これらのデータセットを使用してレポートやダッシュボードを作成するために[ワークスペース全体でアプリ データセットを使用](service-datasets-across-workspaces.md)できるようになります。 

このオプションをオフにすると、アプリに追加する新規ユーザーには、ビルド アクセス許可は付与されなくなります。 ただし、基になっているデータセットに対する既存のアクセス許可は変更されません。 提供されているユーザー インターフェイスを使用すると、ビルド アクセス許可を持つべきではないアプリ ユーザーからそれを手動で削除できます。 ビルド アクセス許可の詳細は[こちら](service-datasets-build-permissions.md#build-permissions-for-shared-datasets)をお読みください。

## <a name="allowing-users-to-make-a-copy-of-the-reports-in-the-app"></a>アプリでレポートのコピーの作成をユーザーに許可する
**[ユーザーがこのアプリ内のレポートのコピーを作成することを許可します]** のオプションをオンにすると、ユーザーはアプリの任意のレポートをマイ ワークスペースに保存できます。 その後で自分のニーズに合わせてレポートをカスタマイズできます。 このオプションでは、 **[Allow all users to connect to the app's underlying datasets using the Build permission]** \(すべてのユーザーがビルド アクセス許可を使用してアプリの基になっているデータセットに接続することを許可する\) を有効にする必要があります。 この機能は、新しい[他のワークスペースからレポートをコピーする](service-datasets-copy-reports.md)機能のように動作します。
