...
ワークスペースは Power BI 管理ポータルで Premium 容量に割り当てることができ、アプリ ワークスペースの場合は **[ワークスペース]** ウィンドウで割り当てることができます。
