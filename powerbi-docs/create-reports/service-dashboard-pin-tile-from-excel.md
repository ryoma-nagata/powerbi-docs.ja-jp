...
2. Power BI から、[[データの取得] > [ファイル] > [OneDrive - Business]](../connect-data/service-excel-workbook-files.md) を選択して Excel ファイルを保存した場所に移動し、**そのブックに接続**します。 ファイルを選択して、 **[接続] > [接続]** を選択します。
