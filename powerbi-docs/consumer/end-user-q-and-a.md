...
## <a name="the-qa-visual"></a>Q&A ビジュアル

Q&A ビジュアルにより、ユーザーが自然言語で質問をし、ビジュアル形式で回答を得ることができます。 Q&A ビジュアルは、他のビジュアルと同様に動作するため、クロスフィルター処理またはクロス強調表示が可能で、ブックマークやコメントもサポートされます。 
...
## <a name="use-the-qa-visual"></a>Q&A ビジュアルを使用する
Q&A ビジュアルを使用するには、提案されたいずれかの質問を選択するか、または自然言語で独自の質問を入力します。 
...
1. 自然言語を使用して Q&A フィールドに質問を入力します。 質問を入力する際は、Power BI のオートコンプリート、入力ヒント、フィードバック機能が利用できます。

    - Power BI によって認識されない単語には、赤色の下線が使用されます。 それらの単語については、Power BI が可能な限り定義を支援します。 適切な定義が表示された場合は、それをドロップダウンから選択してください。  

        ![Q&A の質問ボックスに赤色の下線付きで表示された用語](media/end-user-q-and-a/power-bi-q-and-a-red.png)

    - どの定義も正しくない場合は、別の用語を入力してみるか、赤色の下線で示された単語を選択して、レポートの所有者にその単語を追加するよう依頼します。

        ![Q&A 質問ボックスへの質問の入力](media/end-user-q-and-a/power-bi-q-and-a-owner.png)

    - さらに質問文を入力していくと、質問が認識されなければ Power BI から通知が表示され、支援機能が作動します。 下の例では、Power BI から "候補" というメッセージが表示され、データセット内の用語を使用して別の質問文が提案されています。 

        ![Q&A ビジュアルから提示された修正候補](media/end-user-q-and-a/power-bi-q-and-a-did-you-mean.png)

2. Power BI による修正を選択すると、目的の結果が折れ線グラフとして表示されます。 

    ![折れ線グラフとして表示された Q&A ビジュアルの結果](media/end-user-q-and-a/power-bi-q-and-a-line.png)


3. ただし折れ線グラフは、別の視覚化タイプに変更することができます。  
