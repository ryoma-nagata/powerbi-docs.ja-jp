...
**breadcrumbs (階層リンク)** ワークスペース間をすばやく移動するための、左上にあるナビゲーション。
...
**container (コンテナー)** ナビ ペイン上の領域は "*コンテナー*" です。 ナビ ペインには、次のコンテナーがあります: [お気に入り]、[最近]、[アプリ]、[自分と共有]、[ホーム]。 
...
**My workspace (マイ ワークスペース)** コンテンツを作成するための各 Power BI ユーザー向けのワークスペース。 ここで作成したものをアプリにバンドルする必要があり、"*デザイナー*" 権限がある場合は、適切なワークスペースにそれをアップロードするか、新しいものを作成します。
