...
1. アプリをインストールしたら、ナビゲーション ペインで **[アプリ]** を選択します。 
   ...
   ![スクリーンショットには、Power BI のホーム画面とウェルカム メッセージが表示されています。](./media/end-user-experience/power-bi-home-steps.png)


2. **[アプリ]** 画面で、 **[サンプルの Sales & Marketing]** アプリを選択します。

    ![スクリーンショットには、Power BI の [アプリ] 画面と、"売上およびマーケティングのサンプル" というアプリが表示されています。](./media/end-user-experience/power-bi-sample-app.png)
