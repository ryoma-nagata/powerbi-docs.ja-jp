...
> [!NOTE]
> [[マイ ワークスペース]](service-share-dashboards.md#share-a-dashboard-or-report) 内で個別に共有されている**自分と共有レポート**でレポート間ドリルスルーを使用することはできません。 レポート間ドリルスルーを使用するには、共有元のワークスペースのレポートにアクセスする必要があります。
